...
- ВАЖНО: НИКОГДА не используй "delete_all", если пользователь говорит "удали", "удали эту заметку", "удали задачу", "удали её" — найди наиболее подходящую или последнюю задачу/заметку из списка выше и установи "action": "delete", "targetId": "<ID элемента>", "targetTitle": "<название>".
- Если пользователь просит удалить КОНКРЕТНУЮ задачу/цель/заметку:

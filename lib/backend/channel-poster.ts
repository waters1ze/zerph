...
export async function postWelcomeIntroToChannel(channelId = DEFAULT_CHANNEL): Promise<{ ok: boolean; text?: string; error?: string }> {
  try {
    const prompt =
      ...
      `1. КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО использовать цветные эмодзи.\n` +
      `2. Используй ТОЛЬКО строгие черно-белые Unicode-символы: ✦, ◈, ▪, ▫, ★, ↳, →, <code>, <b>, <blockquote>, <a href="...">.\n` +
      `3. Используй ТОЛЬКО чистый Telegram HTML без Markdown.\n\n` +
      `Содержание поста:\n` +
      `- Заголовок: ✦ <b>ДОБРО ПОЖАЛОВАТЬ В ZERF AI</b> ✦\n` +
      `- Миссия в блоке цитаты: <blockquote><b>Миссия экосистемы:</b> Создать персонального ИИ-ассистента, который берет на себя рутину планирования, фильтрует инфошум и освобождает ваше время для главного.</blockquote>\n` +
      `- Раздел <b>◈ Возможности экосистемы:</b>\n` +
      `  ▪ <b>Голосовое управление</b> — надиктуйте задачи на ходу через Whisper AI, система поймет дату, время и приоритет\n` +
      `  ▪ <b>Vision AI</b> — распознавание расписаний и списков задач по фотографии\n` +
      `  ▪ <b>Живой таймер до дедлайна</b> — обратный отсчет в реальном времени\n` +
      `  ▪ <b>Фокус-сессии Помодоро (25/5)</b> — режим глубокой концентрации\n` +
      `  ▪ <b>Работа в группах (/add)</b> — мгновенное превращение рабочих сообщений в задачи\n` +
      `  ▪ <b>Синхронизация</b> — подключение к Apple и Google Календарю\n` +
      `  ▪ <b>Стрики и награды</b> — бесплатный Premium за непрерывную продуктивность\n` +
      `- Раздел <b>◈ Программа канала:</b>\n` +
      `  ▪ <b>08:00 (Пн–Чт, Сб–Вс)</b> — подробный утренний дайджест IT-новостей, курсы валют и фокус дня\n` +
      `  ▪ <b>08:00 (Пятница)</b> — еженедельный опрос сообщества по новым функциям сервиса\n` +
      `  ▪ <b>21:00 (Пятница)</b> — подведение итогов голосования\n` +
      `  ▪ <b>21:00 (Ежедневно)</b> — вечерний дайджест, итоги дня и вдохновляющая мысль\n` +
      `- Раздел <b>◈ Ссылки и навигация:</b>\n` +
      `  ▪ <b>Telegram-бот:</b> <a href="https://t.me/Zerph_bot">@Zerph_bot</a>\n` +
      `  ▪ <b>Веб-платформа:</b> <a href="https://zeprh.vercel.app">zeprh.vercel.app</a>\n` +
      `  ▪ <b>Обсуждения и предложения:</b> в комментариях к постам канала\n\n` +
      `- Напиши готовый HTML текст сообщения без лишних вступительных фраз.`

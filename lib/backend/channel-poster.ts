...
export async function postDailyMorningPostToChannel(channelId = DEFAULT_CHANNEL): Promise<boolean> {
  ...
  try {
    ...
    const prompt =
      ...
      `Напиши ПОЛНУЮ, глубокую и содержательную утреннюю сводку за сегодня (${context.date}).\n` +
      `Сводка должна объединять три ключевых блока: мировую повестку/геополитику, технологии/ИИ и образование/науку.\n\n` +
      ...
      `- НЕ пиши одни сухие заголовки! По каждому пункту обязательно дай емкое раскрытие (1-2 содержательных предложения с фактами, цифрами, сутью и последствиями).\n` +
      `- ОБЯЗАТЕЛЬНО: в конце каждого пункта приложи кликабельную ссылку на источник в формате: <a href="URL">[Источник]</a>.\n` +
      `- Строгий минимализм: без разноцветных эмодзи. Используй только благородные ч/б символы: ✦, ◈, ▪, <blockquote>, <b>, <code>, <a>.\n\n` +
      `СТРОГАЯ СТРУКТУРА СООБЩЕНИЯ:\n` +
      `✦ <b>ГЛАВНОЕ НА СЕГОДНЯ | ${context.date}</b>\n\n` +
      `◈ <b>Мировая повестка & Геополитика:</b>\n` +
      `▪ <b>[Заголовок мирового/военно-политического события]</b> — [Емкое описание события, факты и краткий прогноз: что будет дальше / к чему готовиться] <a href="[URL_источника]">[Источник]</a>\n\n` +
      `◈ <b>Технологии & ИИ-релизы:</b>\n` +
      `▪ <b>[Заголовок первой IT/ИИ новости]</b> — [Суть релиза/технологии и практический эффект] <a href="[URL_источника]">[Источник]</a>\n\n` +
      `▪ <b>[Заголовок второй IT/ИИ новости]</b> — [Суть релиза/технологии и практический эффект] <a href="[URL_источника]">[Источник]</a>\n\n` +
      `◈ <b>Образование & Наука:</b>\n` +
      `▪ <b>[Заголовок новости об образовании/EdTech/науке]</b> — [Суть открытия/методики, польза для обучения и развития] <a href="[URL_источника]">[Источник]</a>\n\n` +
      `<blockquote><b>Прогноз & Фокус дня:</b> [Краткий стратегический прогноз на день + практический совет по концентрации, сохранению энергии и приоритетам в Zerf Note]</blockquote>\n\n` +

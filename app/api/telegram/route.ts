...
async function handleSiriSetup(chatId: number) {
  ...
  let msg = `🍏 *Интеграция с Siri, Action Button и виджетами*\n\n` +
    ...
    `Если вы хотите, чтобы при необходимости iPhone заводил настоящий будильник в приложении «Часы»:\n` +
    ...
    `4. Внутрь ветки **«Да»** добавьте блок: **«Создать будильник»** *(Время: [Продиктованный текст])*\n` +
